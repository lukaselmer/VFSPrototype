...
namespace VFSBaseTests
{
    ...
    public class FileSystemManipulatorLoadTest
    {
        ...
        private readonly long _dummyFileSize = BinaryMathUtil.KB(100); // TODO: increase this value. Could be BinaryMathUtil.GB(1), but it is disabled, so the unit tests run fast
